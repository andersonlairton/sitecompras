...
<head>
    ...
    if ($Senha == $Confirma_Senha) {
        $sql = sprintf("insert into tb_forncedor_npj (CNPJ,NOME,ENDERECO,EMAIL,TELEFONE,NOME_EMPRESA,SENHA) values ('%s','%s','%s','%s','%s','%s','%s')", $CNPJ, $Nome, $ENDERECO, $Email, $Telefone, $nome_empresa, $Senha);
