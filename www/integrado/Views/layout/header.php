...
<head>
    ...
    <!-- cdn ajax que funcionou no login -->
...
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">rrrr</div>
  <div class="tab-pane fade" id="perfil" role="tabpanel" aria-labelledby="profile-tab">vvvvv</div>
  <div class="tab-pane fade" id="contato" role="tabpanel" aria-labelledby="contact-tab">vvvfff</div>
</div>
-->
